...
from Tools_and_Templates import available_functions  # 调用所有可用工具
import json
import copy
class AgentDemo:
    def __init__(self):
        self.llm = CustomLLM("qwen_online")
        self.system = [{"role": "system", "content": "A helpful and general-purpose AI assistant that has strong language skills."}] # 系统消息
        self.memory = [] # 记忆存储
        self.USER = "user"
